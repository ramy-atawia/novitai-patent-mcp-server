"""
Configuration settings for the Novitai Patent MCP Server.
"""
...
class Settings(BaseSettings):
    ...
    arxiv_user_agent: str = os.getenv("ARXIV_USER_AGENT", "NovitaiPatentMCP/1.0")
    ...
    # MCP Configuration
    mcp_server_url: str = os.getenv("MCP_SERVER_URL", "https://localhost:8001")
    ...
    class Config:
        env_file = [".env", "../.env", "/Users/Mariam/novitai-patent-mcp-server/.env"]
